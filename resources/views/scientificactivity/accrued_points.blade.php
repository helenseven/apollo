...
<div class="container-fluid">
    ...
    <div id="w1">
        <div id="w2" class="card shadow mb-2">
            <div class="card-body">
                <form id="filter-form" class="filter-form" action="/scientificactivity/accrued_points" method="POST">
                        ...
                        <tbody>
                            ...
                            <tr data-key="39270">
                                ...
                                <td class="button">
                                    ...
                                    <div class="btn-table">
                                        <a href="/scientificactivity/get_scan/{{$student->id}}" class="btn-link">
